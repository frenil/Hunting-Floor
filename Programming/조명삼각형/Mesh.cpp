...
CTriangleMeshIlluminated::CTriangleMeshIlluminated(ID3D12Device * pd3dDevice, ID3D12GraphicsCommandList * pd3dCommandList, float fWidth, float fHeight) : CMeshIlluminated(pd3dDevice, pd3dCommandList)
{
	m_nVertices = 6;
	m_nStride = sizeof(CDiffusedVertex);
	m_nOffset = 0;
	...
	pVertices[0] = CDiffusedVertex(XMFLOAT3(0.0f, fHeight, 0.0f), XMFLOAT4(1.0f, 0.0f, 0.0f, 1.0f)); //XMFLOAT4(Colors::Red)
	pVertices[1] = CDiffusedVertex(XMFLOAT3(fWidth, -fHeight, 0.0f), XMFLOAT4(0.0f, 1.0f, 0.0f, 1.0f));
	pVertices[2] = CDiffusedVertex(XMFLOAT3(-fWidth, -fHeight, 0.0f), XMFLOAT4(Colors::Blue)/*XMFLOAT4(0.0f, 0.0f, 1.0f, 1.0f)*/);
	pVertices[3] = CDiffusedVertex(XMFLOAT3(-fWidth, -fHeight, 0.0f), XMFLOAT4(Colors::Blue)/*XMFLOAT4(0.0f, 0.0f, 1.0f, 1.0f)*/);
	pVertices[4] = CDiffusedVertex(XMFLOAT3(fWidth, -fHeight, 0.0f), XMFLOAT4(0.0f, 1.0f, 0.0f, 1.0f));
	pVertices[5] = CDiffusedVertex(XMFLOAT3(0.0f, fHeight, 0.0f), XMFLOAT4(1.0f, 0.0f, 0.0f, 1.0f)); //XMFLOAT4(Colors::Red)
