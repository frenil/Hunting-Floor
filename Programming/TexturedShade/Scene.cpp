...
void CScene::BuildObjects(ID3D12Device *pd3dDevice, ID3D12GraphicsCommandList *pd3dCommandList)
{
	...
	m_ppObjects[0] = new CFlash(pd3dDevice, pd3dCommandList, m_pd3dGraphicsRootSignature);
	...
	m_ppObjects[4] = new CFlash(pd3dDevice, pd3dCommandList, m_pd3dGraphicsRootSignature);
