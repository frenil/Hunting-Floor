...
public:
	...
	virtual void AnimateObjects(float fTimeElapsed, CCamera *p) { }
...
public:
	...
	virtual void BuildObjects(ID3D12Device *pd3dDevice, ID3D12GraphicsCommandList *pd3dCommandList, void *pContext = NULL);
	virtual void BuildTrees(ID3D12Device *pd3dDevice, ID3D12GraphicsCommandList *pd3dCommandList, CCamera *p = NULL, void *pContext = NULL);
	virtual void BuildGrasses(ID3D12Device *pd3dDevice, ID3D12GraphicsCommandList *pd3dCommandList, CCamera *p = NULL, void *pContext = NULL);
	virtual void BuildFlowers(ID3D12Device *pd3dDevice, ID3D12GraphicsCommandList *pd3dCommandList, CCamera *p = NULL, void *pContext = NULL);
	virtual void AnimateObjects(float fTimeElapsed);
	virtual void AnimateObjects(float fTimeElapsed, CCamera *p);
	virtual void ReleaseObjects();
	...
	void SetCamera(CCamera *p) { m_pCamera = p; }
