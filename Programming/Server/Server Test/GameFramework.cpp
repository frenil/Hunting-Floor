...
void CGameFramework::BuildObjects()
{
	...
	m_pNPC = new CTerrainPlayer(m_pd3dDevice, m_pd3dCommandList, m_pScene->GetGraphicsRootSignature(), m_pScene->GetTerrain(), 1);

	//m_pScene->SetPlayer(m_pCamera);

	m_pScene->BuildShader(m_pd3dDevice, m_pd3dCommandList);
...
void CGameFramework::ProcessInput()
{
	...
	int retval = send(sock, (char*)&m_pPlayer->m_xmf4x4World, sizeof(XMFLOAT4X4), 0);
	m_pNPC->m_xmf4x4World = Spos;

	m_pPlayer->Update(m_GameTimer.GetTimeElapsed());
	m_pNPC->Update(m_GameTimer.GetTimeElapsed());
...
{    
	...
	m_pNPC->Render(m_pd3dCommandList, m_pCamera);
